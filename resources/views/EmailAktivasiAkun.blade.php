                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:16px;line-height:22px;text-align:center;color:#555;">
                                                Anda harus mengkonfirmasi email ini jika ingin melakukan aktivasi akun profree yang telah dibuat. jika anda merasa tidak mendaftar abaikan saja email ini.
                                            </div>
                                        </td>
                                    </tr>

                                    <tr>
                                        <a href="http://localhost:9090/konfirmasi-email/{{$kode}}">
                                    ...
                                    <tr>
                                        <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                            ...
                                            <div style="font-family:'Helvetica Neue',Arial,sans-serif;font-size:14px;line-height:22px;text-align:center;color:#555;">
                                                Tolong kirim feedback atau bug info<br> ke <a href="mailto:hanifcraft25@gmail.com" style="color:#2F67F6">hanifcraft25@gmail.com</a>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
