                ...
                <div class="content">
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="main">
                        <tr>
                            <td class="wrapper">
                                <p>Halo</p>
                                <p>Kamu baru saja membuat akun Profree. Klik tombol berikut ini untuk mengaktifkan akun-mu agar dapat di gunakan.</p>
                                        ...
                                        <tr>
                                            <td align="left">
                                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr>
                                                            <td> <a href="<?= url("/konfirmasi-email/" . $kode) ?>" target="_blank">Konfirmasi Email</a> </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </td>
